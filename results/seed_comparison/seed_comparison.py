...
def make_runs(df, num_runs, num_seed):
  IDI_list = []
...
df = make_runs(df, n, num_seed_1)
df = make_runs(df, n, num_seed_2)
df = make_runs(df, n, num_seed_3)

csv_file = os.path.join('result_seed.csv')
